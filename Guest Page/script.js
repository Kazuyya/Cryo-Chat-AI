...
const GOOGLE_API_KEY = "AIzaSyC7WiguyCjifFvsqy9w_9pC2gHkZRStTMQ";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="/src/assets/profile.png" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="/src/assets/logo-icon.png" alt="Gemini avatar">
